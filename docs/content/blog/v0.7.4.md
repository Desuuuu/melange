...
See the [Migrations concept guide](/docs/guides/migrations/) and `melange generate migration --help` for full details.
...
- Added the [Migrations](/docs/guides/migrations/) concept guide covering both the built-in migrator and external migration framework integration, with example SQL output
